...
startMsg = "Hi, welcome to my cipher tool, Please input yes to continue. \nThen input a message and a keyword (or a number) as a key, then select either encrypt or decrypt to run the program. " \
